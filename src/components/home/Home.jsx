...
const TextProgressBar = (props) => {
    return (
        <div className={"text-progress-bar " + props.color} style={{ width: 210 }}>
            <div className={"bar-fill " + props.color} style={{ width: 210 * props.progress }}>
            </div>
            <h4>{props.text}</h4>
        </div>
    )
