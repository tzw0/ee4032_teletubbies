...
import { MainColor, Background, SecondaryColor } from '../../global.scss'
                ...
                <form action="" onSubmit="">
                    <div className="field-container">
                        ...
                        <div className="field">
                            ...
                            <input className="input-field" name="keywords" placeholder="i.e. rgb, mechanical keyboard, typewriter, ..." required input="text" style={{ width: 500 }} />
                        </div>
                    </div>
